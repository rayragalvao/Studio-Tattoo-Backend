...
INSERT INTO estoque (nome, quantidade, unidade_medida, min_aviso) VALUES
    ('Luvas', 1, 'unidades', 10),
    ('Vaselina', 150, 'g', 50),
    ('Tinta preta', 30, 'ml', 50),
    ('Tinta vermelha', 30, 'ml', 50),
    ('Transfer', 30, 'ml', 40),
    ('Solvente', 60, 'ml', 40),
    ('Papel toalha', 4, 'rolos', 10),
    ('Plástico em gel', 60, 'g', 50),
    ('Cartuchos', 5, 'unidades', 20),
    ('Batoque', 100, 'unidades', 80),
    ('Palito de sorvete', 100, 'unidades', 80),
    ('Lâmina de Barbear', 7, 'unidades', 15),
    ('Álcool 70', 1, 'litros', 5),
    ('Plástico filme', 2, 'rolos', 5),
    ('Sabonete líquido neutro', 180, 'ml', 100),
    ('Papel hectográfico', 100, 'folhas', 50),
    ('Máscara descartável', 50, 'unidades', 100),
    ('Papel higiênico', 8, 'unidades', 10),
    ('Água mineral', 4, 'litros', 10),
    ('Sabonete higienizador para as mãos', 200, 'ml', 150);
